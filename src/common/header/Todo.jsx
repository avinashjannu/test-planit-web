...
const ToDo = () => {
  ...
  const handleToggle = (todo) => {
    ...
    // put(properties.NOTES_API + "/" + todo.notesId, todo)
    //   .then((resp) => {
    //     if (resp.status === 200) {
  ...
  const deleteNote = (todo) => {
    showSpinner();
    remove(properties.NOTES_API + "/" + todo.notesId)
      .then((resp) => {
        if (resp.status === 200) {
  ...
  return (
    <li
      className={`dropdown notification-list   ${display && "show"}`}
      id="switchNotes"
    ...
    >
      ...
      >
        ...
        <h4 className="pb-2">My Notes</h4>

        {/* <ToDoList toDoList={toDoList} handleToggle={handleToggle}  />
         */}
        <div
          className="drop-height"
          style={{ overflowX: "hidden", overflowY: "auto", width: "100%" }}
        >
                    ...
                    <div className="pl-0">
                      <div style={{ display: "flex", flexDirection: "row" }}>
                        ...
                        <span
                          ...
                          className={
                            todo.status === "DONE" ? "todo strike" : "todo"
                          }
                        >
                          {todo.notes}
                        </span>
        ...
        <div
          className="add-items form-row mt-2 pl-2"
          style={{ display: "flex" }}
        >
